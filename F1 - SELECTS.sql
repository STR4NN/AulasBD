...
("Franco Colapinto", "Williams", "Estados Unidos", 0, "Alexander Albon", 0, "2000-12-31", "Komatsu", 9),
...
select marca from carros where material_chassi = 'fibra de carbono';
select distinct marca from carros where potencia_carro >  '1000';
select distinct marca from carros where potencia_carro < '1000';
...
select * from pilotos where nacionalidade = "Inglaterra";
select * from pilotos where nacionalidade = "Brasil";
select * from pilotos where nacionalidade = "Mexico";
select * from pilotos where nacionalidade = "Japão";
select * from pilotos where nacionalidade = "Estados Unidos";
select nome from pilotos where equipe = "Mercedes";
select nacionalidade from pilotos where equipe = "Ferrari";
select nome from pilotos where companheiro  = "Lando Norris";
select nome from pilotos where pontos > 90;
select nome from pilotos where pontos < 90;
select * from pilotos where MAX(pontos);
select * from pilotos where MIN(pontos);
select * from pilotos where equipe = 'Willian';
select * from pilotos where equipe = 'Ferrari';
select * from pilotos where equipe = 'McLaren';
